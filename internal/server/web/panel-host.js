import { PANEL_API_VERSION, PANEL_DATA_SCHEMA_VERSION, immutablePanelData, mergePanelSettings, validatePanelManifest } from './panel-api.js';
...
export class PanelHost {
  ...
  swap(requestedId, persist = true) {
    ...
    try {
      ...
      const settings = immutablePanelData(mergePanelSettings(manifest.defaultSettings, this.settings.settings?.[id]));
